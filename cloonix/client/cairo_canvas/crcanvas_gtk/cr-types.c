...
/****************************************************************************/
CrPoints * cr_points_ref(CrPoints *points)
{
  points->ref_count++;
  return points;
}
...
/****************************************************************************/
void cr_points_unref(CrPoints *points)
{
  points->ref_count--;
...
/****************************************************************************/
CrBounds * cr_bounds_ref(CrBounds *bounds)
{
  bounds->ref_count++;
  return bounds;
}
...
/****************************************************************************/
void cr_bounds_unref(CrBounds *bounds)
{
  bounds->ref_count--;
...
/****************************************************************************/
CrDeviceBounds * cr_device_bounds_ref(CrDeviceBounds *device)
{
  device->ref_count++;
  return device;
}
...
/****************************************************************************/
void cr_device_bounds_unref(CrDeviceBounds *device)
{
  device->ref_count--;
...
/****************************************************************************/
CrDash * cr_dash_ref(CrDash *dash)
{
  dash->ref_count++;
  return dash;
}
...
/****************************************************************************/
void cr_dash_unref(CrDash *dash)
{
  dash->ref_count--;
  if (dash->ref_count <= 0)
    {
...
/****************************************************************************/
static gpointer cr_matrix_copy(gpointer p)
{
...
GType cr_matrix_get_type(void)
{
  static GType type = 0;
  if (!type)
    type = g_boxed_type_register_static ("CrMatrix", cr_matrix_copy, g_free);
  return type;
}
/*--------------------------------------------------------------------------*/
