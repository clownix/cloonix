...
#----------------------------------------------------------------------#
DISTRO="trixie"
DEFVIM="/tmp/wkmntloops/usr/share/vim/vim91/defaults.vim"
ROOTFS="/var/lib/cloonix/bulk/${DISTRO}_fr"
...
list_pkt+="sudo,tcpdump,lsof,pciutils,xtrace,strace,"
list_pkt+="hostapd,wpasupplicant,iw,tcpdump"
