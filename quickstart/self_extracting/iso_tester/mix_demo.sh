...
cloonix_cli nemo add kvm kvm1 ram=2000 cpu=2 eth=s bookworm.qcow2 &
...
cloonix_ssh nemo kvm1 "ip addr add dev eth0 1.1.1.2/24"
cloonix_ssh nemo kvm1 "ip link set dev eth0 up"
cloonix_ssh nemo cnt1 "ping -c 10 1.1.1.2"
#----------------------------------------------------------------------
