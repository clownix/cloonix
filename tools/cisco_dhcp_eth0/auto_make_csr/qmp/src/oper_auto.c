...
static void lines_csr1000v(void)
{
  ...
  strcpy(g_lines[g_i++], "username csr privilege 15 secret 0 csr");
  strcpy(g_lines[g_i++], "line vty 0 4");
  strcpy(g_lines[g_i++], "login local");
  strcpy(g_lines[g_i++], "exit");
  strcpy(g_lines[g_i++], "hostname csr");
  ...
  strcpy(g_lines[g_i++], "ip ssh rsa keypair-name csr.demo.net");
  ...
  strcpy(g_lines[g_i++], "username csr");
